                            ...
                            <div class="col-md-12">
                                ...
                                <div class="portlet light bordered">
                                    ...
                                    <div class="portlet-body">
                                         ...
                                         <form action="<?php echo base_url()?>/Blockwords/update">
                              <div class="row">
                                    <div class="col-md-6">
                                ...
                                <?php foreach ($result as $value) { ?>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <input required type="text" name="abuse_word" id="abuse_word" class="form-control  removefirstspace" placeholder="Enter text" value="<?php echo $value->word; ?>" >
