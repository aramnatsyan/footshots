	...
	<div class="page-content">		
		<div class="page-bar">			
			<ul class="page-breadcrumb">				
			 ...
			 <h1 class="page-title">Users Detail	 	</h1>	
			                  <div class="row">
                                ...
                                <div class="profile-sidebar">
                                    ...
                                    <div class="portlet light ">
                                        ...
                                        <div class="row list-separated profile-stat">
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-6">
                                                <div class="uppercase profile-stat-title"> <?php echo $user_detail->FootsFollowing; ?>  </div>
                                                <div class="uppercase profile-stat-text">  Total Following </div>
                                            </div>
                                        </div>
                                        <div class="row list-separated profile-stat">
                                            <div class="col-md-4 col-sm-4 col-xs-6">
                                                <div class="uppercase profile-stat-title"> <?php echo $totalearning; ?> </div>
                                                <div class="uppercase profile-stat-text"> Total Earning </div>
                                            </div>
                                            <div class="col-md-4 col-sm-4 col-xs-6">
                                                <div class="uppercase profile-stat-title"> <?php echo $currentpoint; ?>  </div>
                                                <div class="uppercase profile-stat-text">  Current Point </div>
                                            </div>
                                            <div class="col-md-4 col-sm-4 col-xs-6">
                                                <div class="uppercase profile-stat-title"> <?php echo $totaldonate; ?>  </div>
                                                <div class="uppercase profile-stat-text">  Donated Point </div>
                                            </div>
                                        </div>
                                        <!-- END STAT -->
