	...
	<div class="page-content">		
		<div class="page-bar">			
			<ul class="page-breadcrumb">				
				...
				<li>					
					<span>Hash Tags List</span>				
				</li>			
			</ul>       
			 </div>		
			 <h1 class="page-title">Hash Tags List	</br><small>This is the list of all the hash tags while creating the footshot.</small> 	 	</h1>	
			 <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption font-dark">
                                            ...
                                            <span class="caption-subject bold uppercase">Hash Tags List</span>
                                        </div>
