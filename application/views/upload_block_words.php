        ...
        <div class="page-bar">          
           ...
           <!--   </br>
             ...
             <div class="row">
                        ...
                        <form class="form-horizontal" action="http://test.esolx.net/footshot//Blockwords/upload_words" method="post" enctype="multipart/form-data">
                                         <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input required type="file" id="exampleInputFile" name="file">
                                                        <p class="help-block"> <a href="<?php echo base_url(); ?>upload/sample.csv" download >sample csv</a> </p>
